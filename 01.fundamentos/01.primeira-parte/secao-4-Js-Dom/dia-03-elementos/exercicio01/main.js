...
firstLi.addEventListener('click', ajusteTech);
secondLi.addEventListener('click', ajusteTech);
thirdLi.addEventListener('click', ajusteTech);
...
myWebpage.addEventListener('dblclick', () => {
    window.location.replace('https://ludmilact.github.io/');
});
